<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="apartmentgoa.aspx.cs" Inherits="GreenAmbitLive.apartmentgoa" %>
...
<head runat="server">
    ...
    <title>Studio Apartments in Goa</title>
    <link rel="stylesheet" href="apartmentgoa.css">
...
<body>
    ...
    <div class="img"></div>
    <div class="center">
        <h2 class="title">Studio Apartments in Goa</h2>
    </div>
    ...
    <div class="tag-line">
        <div class="tagline-wrapper">
            ...
            <a href="./apartmentgoa.html" class="button" style="font-weight: 500; background: #EAECE3">Studio Apartments
                in Goa</a>
    ...
    <div class="main-container">
        <div class="row">
            ...
            <div class="column">
                <p>For a multicultural country like India, Goa is a hub for recreation. Apart from the
                    mesmerizing views and tranquil beaches, Goa has become a landmark for real
                    estate. Greenambit works on deluxe projects that make your stay feel like
                    royalty. If you are in search of an affordable option, you can vouch for luxury
                    apartments called The Calissa, and the good news is Greenambit is soon</p>


                <h2 style="margin: 11px 0 21px 0; font-size: 16px;">How Does Studio Apartment Save From
                    Peak-Season Chaos?</h2>

                <p>Most Studio apartments in Goa save you from going through the hassle of peakseason chaos.
                    Furthermore, no
                    time
                ...
                <h2>1. Compact and Relaxed</h2>

                <p>st Studio apartments in Goa save you from going through the hassle of peakseason chaos. Furthermore,
                    no time
                    restrictions are laid in these studio
                    apartments. So, you can arrive or leave as per your wish. There are 3 major ways
                    of how Studio apartments help you in the peak-season crisis.</p>

                <h2>2. Added Amenities</h2>

                <p>Studio Apartments in Goa are packed with amenities. For instance, you will find
                    comfy beds with the TV right across. Basically, you can just plonk into your bed
                    and spend your day watching television. Also, there’s a small kitchen so that you
                    can cook munchies whenever your heart desires. Furthermore, you get 24/7
                    staff service and well-equipped bathrooms. Plus, you will find swimming pools in
                    the complex! So, it’s twice the fun. On the other hand, the apartments are super
                    secure. 24/7 security service and CCTV cameras are put on guard!</p>

                <h2>3. Affordable</h2>

                <p>Studio apartments are definitely cost-effective options if you don’t want to burn
                    a hole in your pocket. Rental studio apartments especially cost way less than 1
                    BHK or 2 BHK apartments. So, you can use the saved money for extra
                    investments or activities. Furthermore, you can check out the studio apartments
                    in North Goa that are located in the hotspots of Goa.</p>

                <h3>Greenambit has so far contributed to the real estate industry in Goa to build
                    organic lifestyles. Our aim is to progress in building lifestyle homes that
                    would be more oriented towards nature. Goa, being a beautiful haven, has
                    inspired us to build homes that will be closer to peace and greenery.</h3>
