<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="thankyou.aspx.cs" Inherits="GreenAmbitLive.thankyou" %>
...
<head runat="server">
  <meta charset="UTF-8">
    ...
    <title>Greenambit Thank You</title>
...
<body>
    ...
    <div class="main-container">
        <div class="row">
            <div class="column">
               <p style="font-family: Unbounded;font-weight: 100;width: 20%;font-size: 69px;margin: 0 auto;line-height: 66px;" class="makeHeight">Thank you!</p>
               <p class="makeHeight">We have received your message. We’ll reach out to you soon.</p>

            <button class="btn-1 makeHeight" onclick="window.location.href = 'http://www.greenambit.com/';">
                <p style="margin: 0;width: auto; font-size: 16px;">BACK TO HOMEPAGE </p><i class="fa-solid fa-arrow-right"></i>
            </button>
            </div>
        </div>
    </div>
        ...
        <div class="content">
            ...
            <div class="link-boxes">
                ...
                <ul class="box" style="position: relative;width: 333px;">
                    ...
                    <li><a href="terms-and-condition.aspx">T & C</a></li>
